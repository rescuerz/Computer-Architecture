...
module  RV32core(
    ...
    // 额外添加的控制信号
    /*
    wire csr_rw_ctrl, csr_w_imm_mux_ctrl;
    wire[1:0] exp_vector_ctrl;
    ...
    */
    ...
    // IF
    // final_PC_IF作为输入，final_PC_IF通过redirectPC
    ...
    // redirect_mux_exp作为控制信号，选择next_PC_IF还是PC_redirect_exp
