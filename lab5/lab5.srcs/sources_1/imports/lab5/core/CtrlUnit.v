...
module CtrlUnit(
    ...
    wire ALU_WAR = (
        (FUS[`FU_MEM][`SRC1_H:`SRC1_L]  != FUS[use_FU][`DST_H:`DST_L] | !FUS[use_FU][`RDY1])  &    //fill sth. here
        (FUS[`FU_MEM][`SRC2_H:`SRC2_L]  != FUS[use_FU][`DST_H:`DST_L] | !FUS[use_FU][`RDY2])  &    //fill sth. here
