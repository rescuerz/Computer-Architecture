...
module CtrlUnit(
    ...
    // fields of FUS are defined at CtrlDefine.vh
    // reg[31:0] FUS[1:5];
    assign normal_stall = (use_FU != `FU_BLANK && FUS[use_FU][`BUSY]) | (|dst && |RRS[dst]);           //fill sth. here
    ...
    wire ALU_WAR = (
        // allow to write
        // !(FUS[`FU_MEM][`SRC1_H:`SRC1_L] == FUS[`FU_ALU][`DST_H:`DST_L] && FUS[`FU_MEM][`RDY1]) == 1  &    //fill sth. here
